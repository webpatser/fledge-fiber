...
use Fledge\Async\Stream\StreamChannel;
use Fledge\Async\Stream\WritableResourceStream;
use Fledge\Async\Cancellation;
use Fledge\Async\Parallel\Context\Internal\AbstractContext;
use Fledge\Async\Parallel\Ipc\IpcHub;
use Fledge\Async\Process\Process;
    ...
    public static function start(
        ...
        if (\str_starts_with(self::SCRIPT_PATH, "phar://")) {
            if (self::$pharScriptPath !== null) {
                ...
                self::$pharScriptPath = $scriptPath = \sys_get_temp_dir() . "/fledge-process-runner-" . $suffix . ".php";
