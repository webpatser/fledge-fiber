...
use Fledge\Async\Process\Internal\ProcessContext;
...
use Fledge\Async\Process\ProcessException;
use const Fledge\Async\Process\BIN_DIR;
    ...
    private function makeCommand(string $workingDirectory): string
    {
        ...
        if (\strncmp($wrapperPath, "phar://", 7) === 0) {
            if (self::$pharWrapperPath === null) {
                ...
                self::$pharWrapperPath = \sys_get_temp_dir() . "/fledge-process-wrapper-" . $fileHash;
