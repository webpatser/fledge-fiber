...
final class ClientTlsContext
{
    ...
    public function withMinimumVersion(int $version): self
    {
        ...
        return clone($this, ['minVersion' => $version]);
    }
    ...
    {
        return clone($this, ['peerName' => $peerName]);
    }
    ...
    {
        return clone($this, ['verifyPeer' => true]);
    }
    ...
    {
        return clone($this, ['verifyPeer' => false]);
    }
    ...
    public function withVerificationDepth(int $verifyDepth): self
    {
        ...
        return clone($this, ['verifyDepth' => $verifyDepth]);
    }
    ...
    {
        return clone($this, ['ciphers' => $ciphers]);
    }
    ...
    {
        return clone($this, ['caFile' => $cafile]);
    }
    ...
    {
        return clone($this, ['caPath' => $capath]);
    }
    ...
    {
        return clone($this, ['capturePeer' => true]);
    }
    ...
    {
        return clone($this, ['capturePeer' => false]);
    }
    ...
    {
        return clone($this, ['sniEnabled' => true]);
    }
    ...
    {
        return clone($this, ['sniEnabled' => false]);
    }
    ...
    public function withSecurityLevel(int $level): self
    {
        ...
        return clone($this, ['securityLevel' => $level]);
    }
    ...
    {
        return clone($this, ['certificate' => $certificate]);
    }
    ...
    public function withPeerFingerprints(array $fingerprints): self
    {
        ...
        return clone($this, ['peerFingerprint' => $fingerprints]);
    }

    public function withoutPeerFingerprints(): self
    {
        return clone($this, ['peerFingerprint' => null]);
    }
    ...
    public function withApplicationLayerProtocols(array $protocols): self
    {
        ...
        return clone($this, ['alpnProtocols' => $protocols]);
    }
