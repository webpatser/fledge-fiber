...
use Fledge\Async\Http\Client\Interceptor\DecompressResponse;
use Fledge\Async\Http\Client\Interceptor\FollowRedirects;
use Fledge\Async\Http\Client\Interceptor\ForbidUriUserInfo;
use Fledge\Async\Http\Client\Interceptor\RetryRequests;
use Fledge\Async\Http\Client\Interceptor\SetRequestHeaderIfUnset;
...
final class HttpClientBuilder
{
    ...
    public function __construct()
    {
        ...
        $this->defaultUserAgentInterceptor = new SetRequestHeaderIfUnset('user-agent', 'fledge-fiber/http-client');
