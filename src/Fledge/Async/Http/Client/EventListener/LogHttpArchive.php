...
namespace Fledge\Async\Http\Client\EventListener;
...
use Fledge\Async\Http\Client\Internal\HarAttributes;
...
use function Fledge\Async\File\filesystem;
    ...
    private function writeLog(Response $response): void
    {
        ...
        try {
            ...
            if ($firstEntry) {
                ...
                $header = '{"log":{"version":"1.2","creator":{"name":"fledge-fiber/http-client","version":"4.x"},"pages":[],"entries":[';
