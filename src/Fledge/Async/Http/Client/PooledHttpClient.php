...
use Fledge\Async\Http\Client\Connection\InterceptedStream;
...
final class PooledHttpClient implements DelegateHttpClient
{
    ...
    {
        return clone($this, ['networkInterceptors' => [...$this->networkInterceptors, $networkInterceptor]]);
    }
    ...
    {
        return clone($this, ['eventListeners' => [...$this->eventListeners, $eventListener]]);
    }
