...
use Fledge\Async\Http\Client\Connection\HttpStream;
...
use Fledge\Async\Http\Client\Trailers;
...
final class Http2ConnectionProcessor implements Http2Processor
{
    ...
    private function ping(): Future
    {
        ...
        $this->writeFrame(Http2Parser::PING, data: $this->counter = \str_increment($this->counter))->ignore();
