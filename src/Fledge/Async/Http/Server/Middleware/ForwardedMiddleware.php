...
use Fledge\Async\Stream\CidrMatcher;
use Fledge\Async\Stream\InternetAddress;

final readonly class ForwardedMiddleware implements Middleware
{
    /** @var list<CidrMatcher> */
    private array $trustedProxies;

    /** @var LocalCache<bool> */
    private LocalCache $trustedIps;
    ...
    public function __construct(
        private ForwardedHeaderType $headerType,
