...
use Fledge\Async\Dns\Internal\Socket;
use Fledge\Async\Dns\Internal\TcpSocket;
use Fledge\Async\Dns\Internal\UdpSocket;
...
final class Rfc1035StubDnsResolver implements DnsResolver
{
    ...
    public const CACHE_PREFIX = "fledge.dns.";
